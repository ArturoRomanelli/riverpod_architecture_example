...
_CurrentApiModel _$CurrentApiModelFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_CurrentApiModel',
      json,
      ($checkedConvert) {
        final val = _CurrentApiModel(
...
Map<String, dynamic> _$CurrentApiModelToJson(_CurrentApiModel instance) =>
    <String, dynamic>{
