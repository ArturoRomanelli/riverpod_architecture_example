...
extension LocationApiModelPatterns on LocationApiModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String name, String country, int? id, String? region,
    ...
    switch (_that) {
      case _LocationApiModel() when $default != null:
        return $default(_that.name, _that.country, _that.id, _that.region,
            _that.lat, _that.lon, _that.url);
      case _:
        return orElse();
    }
  }
